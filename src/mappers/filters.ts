...
import { CategoryCheckboxConfig, CategoryCheckboxOption } from "../interfaces/category";
import { IRegionCheckboxOption, RegionCheckboxConfig } from "../interfaces/region";

function mapCategoryFilterToConfig(categoryFilter: CategoryCheckboxOption[]): CategoryCheckboxConfig[] {
...
function mapRegionFilterToConfig(regionFilter: IRegionCheckboxOption[]): RegionCheckboxConfig[] {
...
export function mapFilterStateToConfig(filterState: IFiltersState): FiltersConfig {
    let filterConfig = {
